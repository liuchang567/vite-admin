  ...
  <div class="login">
    <el-form ref="form" :model="form" :rules="rules" class="login-form">
      ...
      <el-form-item label="" prop="password">
        <el-input v-model="form.password" placeholder="密码" show-password @keypress.enter.native="onSubmit"></el-input>
      </el-form-item>
      <el-form-item>
